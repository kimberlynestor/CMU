...
var_corr_cort_cb = Line2D([0], [0], c=p_dict['var_corr_cort_cb'], lw=2, label='Cortex & Cb', ls='-', alpha=1)
var_corr_cort_bg = Line2D([0], [0], c=p_dict['var_corr_cort_bg'], lw=2, label='Cortex & Bg', ls='-', alpha=1)
var_corr_cb_bg = Line2D([0], [0], c=p_dict['var_corr_cb_bg'], lw=2, label='Cb & Bg', ls='-', alpha=1)
